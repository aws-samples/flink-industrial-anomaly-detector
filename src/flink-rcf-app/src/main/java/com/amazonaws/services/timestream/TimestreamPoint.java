...
public class TimestreamPoint {
	...
	public TimestreamPoint(TimestreamPoint anotherPoint, String measureName, String measureValue,
	...
	public String toString() {
		return "TimestreamPoint{" + "measureName='" + measureName + '\'' + ", measureValueType=" + measureValueType
				+ ", measureValue='" + measureValue + '\'' + ", time=" + time + ", timeUnit='" + timeUnit + '\''
