...
/**
 * Checks if required database and table exists in Timestream. If they do not
...
public class TimestreamInitializer {
	...
	public TimestreamInitializer(String region) {
		...
		this.writeClient = AmazonTimestreamWriteClientBuilder.standard().withRegion(region)
	...
	public void createTable(String databaseName, String tableName) {
		...
		try {
			...
			System.out.println(
					"Table [" + tableName + "] exists on database [" + databaseName + "]. Skipping table creation");
		}
	}
}
